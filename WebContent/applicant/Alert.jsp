...
<body><h5 align="right">Your Applicant id is ' <c:property value="#session.appli.aid"/> '        <c:a href="/hr/basic1/Logout.action">Sign_Out</c:a></h5>
<div id="header">
			<ul>
...
<div id="body">
		<div class="contact">
<h3><i>Already Register</i>   <a href="../index.jsp">Sign in</a></h3>
</div>
	</div>
		<div id="footer">
			<div>
