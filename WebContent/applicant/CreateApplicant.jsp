...
var aemail1=document.sampleform.aemail1.value;
...
if(aemail1=="")
{alert("enter your primary email id");document.sampleform.aemail1.focus();return false;}
if(!aemail1.match(emailExp))
{alert("enter valid email id");document.sampleform.aemail1.focus();return false;}
if(aadd1=="")
...
if(sscyoa < 1920 || sscyoa > 2011 || !sscyoa.match(digitsExp) )
...
if(sscyop < 1920 || sscyop > 2011 || sscyoa > sscyop || !sscyop.match(digitsExp))
...
if(hscyoa < 1920 || hscyoa > 2011 || !hscyoa.match(digitsExp))
...
if(hscyop < 1920 || hscyop > 2011 || hscyoa > hscyop || !hscyop.match(digitsExp))
...
<body>
	...
	<div id="body">
		<div class="products">
			<h1>Registration</h1>
			<form  name="sampleform" action="/hr/applicant/createapplicant.action" method="post" onsubmit="return validate(this.form)" >
...
<tr><td>Enter name</td><td><input type="text" name="afname" /> </td> <td><input type="text" name="amname"/> </td><td><input type="text" name="alname"/> </td> </tr>
<tr>
...
<tr>
      ...
      <td><input type="password" name="apassword"/></td></tr>
<tr>
      <td>Father Name<span class="mandatory">*</span></td>
      <td><input type="text" name="frname"/></td></tr>
<tr>
      <td>Date Of Birth(mm/dd/yyyy)<span class="mandatory">*</span></td>
      <td><input type="text" name="adob" readonly=""/><a href="javascript:showCal('Calendar1')"><img src="../images/cal.gif"></a></td></tr>
<tr>
      <td>Mobile Number<span class="mandatory">*</span></td>
      <td><input type="text" name="amobile" /></td></tr>
<tr>
      <td>Landline Number<span class="mandatory">*</span></td>
      <td><input type="text" name="allno" /></td></tr>
<tr>
      <td>Login Email id<span class="mandatory">*</span></td>
      <td><input type="text" name="aemail1"/></td></tr>
<tr>  
      <td>Alternate Email id</td>
	  <td><input type="text" name="aemail2"/></td></tr>
<tr>
	  <td>Communication Address:</td></tr>
<tr>
      <td>Address line1<span class="mandatory">*</span></td>
      <td><input type="text" name="aadd1"/></td></tr>
<tr>
	<td>Address line2</td>
	<td><input type="text" name="aadd2"/></td></tr>
<tr>
      <td>City<span class="mandatory">*</span></td>
      <td><input type="text" name="acity"/></td></tr>
<tr>
      <td>Pincode<span class="mandatory">*</span></td>
      <td><input type="text" name="apincode" /></td></tr>
<tr>
      <td>State<span class="mandatory">*</span></td>
      <td><input type="text" name="astate"/></td></tr>
<tr>
      <td>Nationality<span class="mandatory">*</span></td>
      <td><input type="text" name="anationality"/></td></tr>
...
<tr>
      ...
      <td><input type="text" name="sscyoa" size="4"/></td>
      <td>Year of Passing<span class="mandatory">*</span></td>
      <td><input type="text" name="sscyop" size="4"/></td>
</tr>
<tr>
      <td>School Name<span class="mandatory">*</span></td>
      <td><input type="text" name="sscsch"/></td>
	  <td>Board<span class="mandatory">*</span></td>
      <td><input type="text" name="sscboard"/></td>
</tr>
<tr>
      <td>Percentage<span class="mandatory">*</span></td>
      <td><input type="text" name="sscpercent"/></td></tr>

<tr><td>HSC</td></tr>
<tr>
      <td>Year of Applying<span class="mandatory">*</span></td>
      <td><input type="text" name="hscyoa" size="4"/></td>
      <td>Year of Passing<span class="mandatory">*</span></td>
      <td><input type="text" name="hscyop" size="4"/></td>
</tr>
<tr>
      <td>School Name<span class="mandatory">*</span></td>
      <td><input type="text" name="hscsch"/></td>
	  <td>Board<span class="mandatory">*</span></td>
      <td><input type="text" name="hscboard"/></td>
</tr>
<tr>
      <td>Percentage<span class="mandatory">*</span></td>
      <td><input type="text" name="hscpercent"/></td></tr>
...
<tr>
	...
	<td>
      ...
      <td><input type="text" name="gbranch"/></td></tr>
<tr>
      <td>Year of Applying<span class="mandatory">*</span></td>
      <td><input type="text" name="gyoa" size="4"/></td>
      <td>Year of Passing<span class="mandatory">*</span></td>
      <td><input type="text" name="gyob" size="4"/></td>
</tr>
<tr>
      <td>College Name<span class="mandatory">*</span></td>
      <td><input type="text" name="gcoll"/></td>
	  <td>University<span class="mandatory">*</span></td>
      <td><input type="text" name="guni"/></td>
</tr>
	<tr><td>Percentage<span class="mandatory">*</span></td>
	<td><input type="text" name="gpercent"/></td></tr>
...
<tr><td>Course</td>
	...
	<td>Branch</td>
	<td><input type="text" name="pgbranch"/></td></tr>
<tr>
	<td>Year of Applying</td>
	<td><input type="text" name="pgyoa"/></td>
    <td>Year of Passing</td><td><input type="text" name="pgyop"/></td>
</tr>
<tr>
	<td>College Name</td><td><input type="text" name="pgcoll"/></td>
	<td>University</td><td><input type="text" name="pguniv"/></td>
</tr>
<tr>
	<td>Percentage</td>
	<td><input type="text" name="pgpercent"/></td></tr>
<tr>
      <td>Skills<span class="mandatory">*</span></td>
      <td><input type="text" name="skills"/></td></tr>
<tr>
      <td>Others</td>
      <td><textarea name="others"></textarea></td></tr>
