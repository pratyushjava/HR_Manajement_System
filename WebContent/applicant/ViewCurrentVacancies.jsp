...
<head>
<meta charset="utf-8" />
<title>View Current Vacancies</title>
...
<body>
	...
	<div id="header">
			<ul>
				...
				<li class="selected"><c:a href="/hr/applicant/viewcurrentvacancy.action"><span>view_current vacancy</span></c:a></li>
				<li><c:a href="/hr/applicant/viewvapplied.action" ><span>view_vacancy applied</span></c:a></li>
							
			</ul>
	</div>
<div id="body"><div class="services">
...
<tr>
	...
	<td><c:url action="apply.action" id="apply" ><c:param name="vid"><c:property value="#itera.vid" /></c:param></c:url><a href="<c:property value="#apply"/>">Apply</a></td>
<tr/>
