...
<body><form  name="sampleform" action="/hr/applicant/edit.action" method="post" onsubmit="return validate(this.form)">
	...
	<div id="header">
			<ul>
				...
				<li class="selected"><a href="EditApplicant.jsp"><span>Edit Profile</span></a></li>
			...
			<div id="body">
		<div class="services">
			<h1>Edit Details , <c:property value="#session.appli.afname"/></h1>
			
			<form  name="sampleform" action="/hr/applicant/edit.action" method="post" onsubmit="return validate(this.form)">
...
<tr>
      <td>Others</td>
      <td><textarea name="others" value=<c:property value="#itera.others" /> ></textarea></td></tr>
