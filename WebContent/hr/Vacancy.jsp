...
<body><h5 align="right">Your HR id is  ' <c:property value="#session.eid"/> '           <c:a href="/hr/basic1/Logout.action">Sign_Out</c:a></h5>
	<div id="header">		
			<ul>
				...
				<li class="selected"><a href="../hr/Vacancy.jsp"><span>Vacancy</span></a></li>
	...
	<div id="body">
		<div class="services">
			<h1>Vacancy</h1>
			<table align="center">
			<tr><td><b>Vacancy:</b></td></tr>
<tr><td>Create Vacancy</td><td><a href="../hr/createvacancy.jsp">click</a></td></tr>

<tr><td>View All Vacancy Details</td><td><c:a href="/hr/basic1/ActionTag.action">click</c:a></td></tr>
</table>
